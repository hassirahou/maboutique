...
// register preschool_and_kindergarten_Recent_Post widget
function preschool_and_kindergarten_register_recent_post_widget() {
    register_widget( 'preschool_and_kindergarten_Recent_Post' );
}
add_action( 'widgets_init', 'preschool_and_kindergarten_register_recent_post_widget' );
 
 /**
 * Adds preschool_and_kindergarten_Recent_Post widget.
 */
class preschool_and_kindergarten_Recent_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'preschool_and_kindergarten_recent_post', // Base ID
			__( 'RARA: Recent Post', 'preschool-and-kindergarten' ), // Name
			array( 'description' => __( 'A Recent Post Widget', 'preschool-and-kindergarten' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
        ...
        $title      = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Recent Posts', 'preschool-and-kindergarten' );
...
} // class preschool_and_kindergarten_Recent_Post